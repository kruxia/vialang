...
var grammar = {
    ...
    {"name": "While$subexpression$1", "symbols": ["Object"]},
    ...
    {"name": "Both$subexpression$1", "symbols": ["Object"]},
    {"name": "Both$subexpression$2", "symbols": ["Boolean"]},
    {"name": "Both$subexpression$2", "symbols": ["Object"]},
    ...
    {"name": "Either$subexpression$1", "symbols": ["Object"]},
    {"name": "Either$subexpression$2", "symbols": ["Boolean"]},
    {"name": "Either$subexpression$2", "symbols": ["Object"]},
    ...
    {"name": "Not$subexpression$1", "symbols": ["Object"]},
    {"name": "Not", "symbols": [(lexer.has("NOT") ? {type: "NOT"} : NOT), "_", "Not$subexpression$1"], "postprocess": function(d) {return {type: 'Not', value: d[2][0]}}},
    {"name": "Comparison", "symbols": ["Object", "_", "Compare", "_", "Object"], "postprocess": function(d) {return {type: 'Comparison', value: d}}},
    {"name": "Compare", "symbols": ["NotCompare"]},
    {"name": "Compare", "symbols": ["OrCompare"]},
    {"name": "Compare", "symbols": ["CompareOp"]},
    {"name": "NotCompare", "symbols": [(lexer.has("NOT") ? {type: "NOT"} : NOT), "_", "Compare"], "postprocess": function(d) {return {type: 'NotCompare', value: d}}},
    {"name": "OrCompare", "symbols": ["CompareOp", "_", (lexer.has("OR") ? {type: "OR"} : OR), "_", "CompareOp"], "postprocess": function(d) {return {type: 'OrCompare', value: [d[0], d[2]]}}},
    {"name": "CompareOp", "symbols": [(lexer.has("LESS_THAN") ? {type: "LESS_THAN"} : LESS_THAN)]},
    {"name": "CompareOp", "symbols": [(lexer.has("GREATER_THAN") ? {type: "GREATER_THAN"} : GREATER_THAN)]},
    {"name": "CompareOp", "symbols": [(lexer.has("EQUAL_TO") ? {type: "EQUAL_TO"} : EQUAL_TO)], "postprocess": function(d) {return {type: 'CompareOp', value: d}}},
